...
export default function TeamResumeProgress({ data }: TeamResumContentsProps) {
  return (
    <div className="w-full rounded-2xl bg-[#fff] px-4 pb-16 pt-4 shadow-resume-box-shadow sm:px-[2.06rem] sm:pt-[1.38rem]">
      {/* title */}
      <div className="flex flex-col gap-[0.56rem] sm:flex-row sm:items-center">
        <span className="text-base font-semibold text-grey100 sm:text-lg">프로필 완성도 : {data?.teamCompletion}%</span>
      ...
      <div className="flex flex-col">
        {/* 수치 */}
        <div className="relative hidden w-full pt-6 sm:flex">
