  ...
  return (
    <>
      <div className="w-full h-screen flex">
        {/* left container */}
        <div className="w-1/2 h-full bg-[#D3E1FE]"></div>
        ...
        <div className="w-1/2 h-full p-8">
          ...
          <div className="flex flex-col items-center gap-2 pt-6">
            <div className="flex w-[26rem] h-[3.5rem] px-32 bg-[#00C73C] rounded items-center gap-1 cursor-pointer">
            ...
            <div className="flex w-[26rem] h-[3.5rem] px-32 bg-[#FFE500] rounded items-center gap-1 cursor-pointer">
              <Image src={'/assets/login/kakaoLogo.svg'} width={39} height={56} alt="kakaoLogin" />
              <span className="font-semibold">카카오로 시작하기</span>
            </div>
            <div className="flex w-[26rem] h-[3.5rem] px-[8.5rem] items-cente gap-3 items-center border-[1px] border-grey30 rounded cursor-pointer">
          ...
          <div className="w-full flex justify-center pt-28">
            <span className="text-xs text-grey60 font-normal">
