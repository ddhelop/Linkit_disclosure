...
export default function IntroComponent2() {
  return (
    <>
      <div className="bg-[#F0F2F6] relative snap-start h-screen flex flex-col min-h-[540px] md:min-h-screen bg-no-repeat bg-cover bg-white bg-opacity-50 overflow-hidden">
        <div className="w-full h-[80%] flex flex-col justify-center pl-[11rem]  bg-[#fff]">
          <span className="text-[2.625rem] font-bold">
            자유로운
            <br />
            자기 PR의 공간
          </span>

          <span className="text-[1.25rem] font-medium text-grey70 pt-8">링킷에서 자유롭게 나를 홍보하세요,</span>
          <span className="text-[1.25rem] font-medium text-grey70 pt-1">수도권 대학 20여개 학생들이 함께 합니다.</span>
        </div>

        <div className="w-[16.2rem] h-[22.3rem] p-5 opacity-80 absolute rounded-xl right-[6.39rem] top-[13.5rem] shadow-card-shadow">
        ...
        <div className="w-[22.1rem] h-[31.3rem] p-6 flex flex-col absolute rounded-xl right-[17.2rem] top-[9.2rem] shadow-card-shadow bg-[#fff]">
