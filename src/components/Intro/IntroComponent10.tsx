...
export default function IntroComponent10() {
  ...
  return (
    <motion.div
      className="relative flex h-screen min-h-screen w-full flex-col items-center justify-start overflow-hidden bg-white bg-opacity-50 bg-cover bg-no-repeat py-20 sm:snap-mandatory sm:snap-start sm:snap-always lg:justify-center lg:pt-32"
