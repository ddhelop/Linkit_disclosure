...
export default function IntroComponentTemp() {
  ...
  return (
    <>
      <div
        className="w-full relative pt-20 md:pt-0 snap-start h-screen flex flex-col items-center justify-center min-h-screen bg-no-repeat bg-cover bg-opacity-50 overflow-hidden"
      ...
      >
        ...
        <motion.div
          ...
          className="w-[82%] md:w-[31.6rem] h-[24.9rem] md:h-[21.9rem] z-50 shadow-frame-shaow rounded-[3.125rem] bg-[rgba(79, 81, 98, 0.07)] backdrop-blur-2xl"
        >
          <div className=" py-[1.65rem] flex flex-col items-center z-50">
            ...
            <div className="flex flex-col md:flex-row items-center w-[22.4rem] justify-between pt-10">
              ...
              <div className="flex flex-col text-left justify-center p-4 md:p-0">
                <span className="font-medium text-center">7월 팀빌딩을 위한</span>
                <span className="font-bold text-[2rem]">{positions[selectedRole].text}</span>
              </div>
            </div>
            <div className="flex items-center gap-4 md:mt-8 cursor-pointer justify-center w-[14.25rem] h-[4.4rem] bg-[#2F353C] rounded-[3.75rem]">
